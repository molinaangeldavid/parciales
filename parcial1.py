...
# def numero_pequenio(numero: int)->int:  
#     suma = 0
#     lista = []
#     while suma<=numero:
#         ingresar = int(input('Ingrese el numero: '))
#         suma += ingresar
...
# def main()->None:
#     palabras_iguales = []
#     primer_palabra = input('Ingrese la primer palabra: ') #poder
#     letras_palabra_uno = list(primer_palabra)  #letras de la primer palabra
#     for i in range(5):
#         mas_palabras = input(f'Ahora ingrese la palabra {i+1}: ') # polos
#         letra_otras_palabras = list(mas_palabras)  #letras de las 5 palabras
#         if len(mas_palabras) == len(primer_palabra):
#             for letra in letras_palabra_uno:
#                 if letra in letra_otras_palabras:
#                     letra_otras_palabras.remove(letra)
#                     if len(letra_otras_palabras)==0:
#                         palabras_iguales.append(mas_palabras)
